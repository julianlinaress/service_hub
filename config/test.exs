...
config :service_hub,
  ...
  http_client: ServiceHub.HTTPClientStub
...
config :service_hub, ServiceHubWeb.Endpoint,
  ...
  secret_key_base: "ExIcSbWja1/LWg+Mu7VoH6Eee49aPXO6FuRFro6KByDmXJy+DqUJLmz5hpJZwayh",
  server: false

# In test we don't send emails
config :service_hub, ServiceHub.Mailer, adapter: Swoosh.Adapters.Test
