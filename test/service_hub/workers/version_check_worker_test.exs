defmodule ServiceHub.Workers.VersionCheckWorkerTest do
  ...
  describe "perform/1" do
    ...
    test "updates target state on deployment not found" do
      ...
      assert :ok = perform_job(VersionCheckWorker, %{target_id: 99999})
      ...
      assert run.automation_id == "deployment_version"
    end
  end
end
